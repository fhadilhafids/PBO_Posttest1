...
public class Postttest1 {
    ...
    public interface wilayah{
        void tol();
        void kota();
    }
    
    public class strategis implements wilayah {




        public void tol(){
            System.out.println("Dekat dengan tol jagawara dan tol saga");
        }

        public void kota(){
            System.out.println("Dekat dengan Mall Matahari");
        }
    }
